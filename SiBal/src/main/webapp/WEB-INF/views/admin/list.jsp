    	...
    	<tr>
    		<td colspan="5">
			  <ul class="pagination justify-content-center" >
			    ...
			    <li class="page-item">
					<a  class="page-link" href="../admin/list.do?nowPage=${PINFO.startPage-1}">이전</a>
			    </li>
				</c:if>
			    <c:forEach  var="page" begin="${PINFO.startPage}" end="${PINFO.endPage}" step="1">
			    <li class="page-item">
			    	<a class="page-link" href="../admin/list.do?nowPage=${page}">${page}</a>
			    </li>
			    </c:forEach>
			    ...
			    <li class="page-item">
			    	<a class="page-link" href="../admin/list.do?nowPage=${PINFO.endPage+1}">다음</a>
			    </li>
				</c:if>
			  </ul>
	  		</td>
