...
public class ApiExplorer {
	public static String getAirportData(String depAirportId, String arrAirportId, String depPlandTime)
		...
		urlBuilder.append("?" + URLEncoder.encode("ServiceKey", "UTF-8")
				+ "=ZzgPKcfrdL46Znc6aWHPQSTGvxV0raIr%2BYieCjm%2BD5zbTllAnvi6%2BTbwqUh9czCO1OUuVNFPniXPHroT%2Fr7Xaw%3D%3D"); /*
																															 * Service
																															 * Key
																															 */
		...
		urlBuilder
				.append("&" + URLEncoder.encode("_type", "UTF-8") + "=" + URLEncoder.encode("json", "UTF-8")); /* 출발일 */
...
//        System.out.println(sb.toString());
		System.out.println("파일 받아오기 성공");
		return sb.toString();

	}

	// Json으로 만들기
	public static List<AirVO> getAirportJson(String depAirportId, String arrAirportId, String depPlandTime)
			throws Exception {
...
//    	List<AirVO> list = (List<AirVO>) gson.fromJson(a_item.toString(), AirVO.class);
		List<AirVO> list = gson.fromJson(a_item.toString(), new TypeToken<List<AirVO>>() {
		}.getType());
		/*
		 * for(AirVO airVO : list){ System.out.println(airVO.getArrPlandTime()); }
		 */
