	...
	<div class="container">
	  ...
	  <form action="../qnaBoard/qWriteProc.do" >
	    <div class="form-group">
	      ...
	      <input type="text" class="form-control" id="title" name="title" maxlength="30" required="required">
	    </div>
	    <div class="form-group">
	      <label for="content">내용:</label>
	      <textarea class="form-control" rows="5" id="content" name="content" maxlength="1000" required="required"></textarea>
	    </div>
	    <div class="form-group">
	      <label for="id">작성자</label>
	      <input type="text" class="form-control" id="id" name="id" value="${sessionScope.nick}" readonly="readonly" required="required" >
	    </div>
	    <button type="submit" class="btn btn-dark" id="qBtn">질문하기</button>
